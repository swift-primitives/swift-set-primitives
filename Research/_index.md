...
|----------|-------|------|--------|
| Noncopyable Hashable Architecture.md | Hashable architecture for ~Copyable types | 2026-01-22 | DECISION |
| set-bit-packed-to-vector-naming.md | Rename Set<Bit>.Packed to Set<Bit>.Vector | 2026-01-29 | DECISION |
| array-set-primitives-comparison.md | Comparative analysis of Array vs Set primitives | 2026-01-29 | DECISION |
