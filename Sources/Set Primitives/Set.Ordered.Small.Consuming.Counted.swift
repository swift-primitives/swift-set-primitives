...
extension Set_Primitives.Set.Ordered.Small.Consuming {
    ...
    ///
    /// ```swift
    /// func collect(nodes: consuming Set<Node>.Ordered.Small<4>) -> [Node] {
...
extension Set_Primitives.Set.Ordered.Small.Consuming.Counted: @unchecked Sendable where Element: Sendable {}
