...
extension Set_Primitives.Set.Ordered.Bounded.Consuming {
    ...
    public struct Iterator: ~Copyable {
        ...
        @usableFromInline
        init(_consuming set: consuming Set_Primitives.Set<Element>.Ordered.Bounded) {
            var mutableSet = set
...
extension Set_Primitives.Set.Ordered.Bounded.Consuming.Iterator: @unchecked Sendable where Element: Sendable {}
