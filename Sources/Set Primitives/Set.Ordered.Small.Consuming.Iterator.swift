...
extension Set_Primitives.Set.Ordered.Small.Consuming {
    ...
    public struct Iterator: ~Copyable {
        ...
        @usableFromInline
        let _heapStorage: Set_Primitives.Set<Element>.Ordered.ElementStorage?
        ...
        @usableFromInline
        init(_consuming set: consuming Set_Primitives.Set<Element>.Ordered.Small<inlineCapacity>) {
...
extension Set_Primitives.Set.Ordered.Small.Consuming.Iterator: @unchecked Sendable where Element: Sendable {}
