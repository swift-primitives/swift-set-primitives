...
extension Set_Primitives_Core.Set.Ordered.Consuming {
    ...
    public struct Iterator: ~Copyable {
        ...
        @usableFromInline
        init(_consuming set: consuming Set_Primitives_Core.Set<Element>.Ordered) {
        ...
        deinit {
            ...
            storage.deinitializeElements(from: index, count: count - index)
        }
    }
}
...
extension Set_Primitives_Core.Set.Ordered.Consuming.Iterator: @unchecked Sendable where Element: Sendable {}
