...
extension Set_Primitives_Core.Set.Ordered.Inline.Consuming {
    ...
    ///
    /// ```swift
    /// func collect(nodes: consuming Set<Node>.Ordered.Inline<8>) -> [Node] {
...
extension Set_Primitives_Core.Set.Ordered.Inline.Consuming.Counted: @unchecked Sendable where Element: Sendable {}
