...
extension Set_Primitives_Core.Set.Ordered.Bounded: Sequence.Drain.`Protocol` {
    // drain(_ body:) method already exists in Set.Ordered.Bounded.swift
}
...
extension Set_Primitives_Core.Set.Ordered.Bounded {
    ...
    ///
    /// ```swift
    /// var set = Set<Int>.Ordered.Bounded([1, 2, 3], capacity: 10)
